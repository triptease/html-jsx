...
const prettierConfig: Options = JSON.parse(fs.readFileSync('../.prettierrc', 'utf-8'));
const formatted = await format(typesFile.getFullText(), prettierConfig);
typesFile.replaceWithText(formatted);
